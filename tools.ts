...
import { gitExec, syncRepository } from "./memory-md.js";
import { readMemoryFile, listMemoryFiles, writeMemoryFile } from "./memory-md.js";
import { getMemoryDir, getCurrentDate } from "./memory-md.js";
...
export function registerMemoryWrite(
    ...
    pi.registerTool({
        ...
        async execute(_toolCallId, params, _signal, _onUpdate, ctx) {
            const { path: relPath, content, description, tags } = params as {
                path: string;
                content: string;
                description: string;
                tags?: string[];
...
export function registerMemorySearch(
    ...
    pi.registerTool({
        ...
        parameters: Type.Object({
            ...
            searchIn: Type.Union(
                [Type.Literal("content"), Type.Literal("tags"), Type.Literal("description")],
